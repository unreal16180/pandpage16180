...
Este es un documento en **Markdown**.

- Se carga desde un archivo externo `.md`.
- El texto se muestra como “documento” y está justificado.
- Puedes buscar palabras con el panel de herramientas.

## Sección 1

Pega aquí tu contenido real.
